...
<title>Broadway Electronics - Negozio</title>
</head>
<body>
		...
		<div class="filtri">
			<form action="negozio.jsp" method="GET">
				...
				<div class="filtro">
					...
					<div class="filtro-content">
						<div>
							<input type="checkbox" id="categoria_console" name="cat"
								value="console"
								<%=f_categorie.contains("console") ? "checked" : ""%> /> <label
								for="categoria_console">Console</label>
						</div>
						<div>
							<input type="checkbox" id="categoria_smartphone" name="cat"
								value="smartphone"
								<%=f_categorie.contains("smartphone") ? "checked" : ""%> /> <label
								for="categoria_smartphone">Smartphone</label>
						</div>
						<div>
							<input type="checkbox" id="categoria_computer"
								name="cat" value="computer"
								<%=f_categorie.contains("computer") ? "checked" : ""%> />
							<label for="categoria_computer">Computer</label>
						</div>
						<div>
							<input type="checkbox" id="categoria_" name="cat"
								value="accessori"
								<%=f_categorie.contains("Accessori") ? "checked" : ""%> /> <label
								for="categoria_pianoforti">Accessori</label>
						</div>
