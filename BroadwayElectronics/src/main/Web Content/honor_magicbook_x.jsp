...
<div class="container">
  ...
  <div class="row">
  <div class="col-2">
  <img src="images/honor_magicbook_x.jpg" width =100%>
  </div>
  <div class="col-2">
  <p>Honor </p>
  <h1>Honor MagicBook  X 15</h1>
  <h4>€650.00</h4>
  <input type="number" value="1">
   <button onclick="addToCart(1)" class="btn">Aggiungi al carrello</button>
  <h3>Caratteristiche del prodotto</h3>
  <p> Arrivederci surriscaldamento, Benvenute performance:La ventola ha un design a lame ultra fini che ruotano ad alta intensità, permettendo una migliore dissipazione del calore; di conseguenza, puoi continuare ad utilizzare il tuo notebook senza episodi di surriscaldamento
...
Collaborazione Multi-schermo：La collaborazione multi-schermo ti permette di condividere lo schermo e i file del tuo smartphone su portatile,</p>
  </div>
 </div>
 </div>
