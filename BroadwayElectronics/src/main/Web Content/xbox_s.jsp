...
<title>Xbox Series S - Broadway Electronics</title>
...
<div class="container">
  ...
  <div class="row">
  <div class="col-2">
  <img src="images/xbox_s.jpg" width =100%>
  </div>
  <div class="col-2">
  <p>Xbox</p>
  <h1>Xbox Series S</h1>
  ...
  <p> Arriva la nuova Xbox Series S, la console Xbox più piccola ed elegante di sempre. Prova la velocità e le prestazioni di ultima generazione di una console all-digital ad un prezzo straordinario
      Punta tutto sul digitale e gioca senza disco con la console Xbox più piccola di sempre. Sperimenta velocità e prestazioni di nuova generazione grazie a Xbox Velocity Architecture, con SSD personalizzata e software integrato
Gioca a migliaia di giochi di quattro generazioni di Xbox con retrocompatibilità, inclusi titoli ottimizzati al momento del lancio</p>
  </div>
 </div>
 </div>
