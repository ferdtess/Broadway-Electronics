...
<div class="container">
  ...
  <div class="row">
  <div class="col-2">
  <img src="images/honor_magic5.jpg" width =100%>
  </div>
  <div class="col-2">
  <p>Honor </p>
  ...
  <p> HONOR Magic 5 Pro è in grado di rilevare i movimenti e acquisire automaticamente lo scatto migliore. Cattura con rilevamento di movimenti è dotata di accuratezza a livello di millisecondo e ti consente di scattare foto facilmente, di giorno o di notte, da lontano o in primo piano. Al primo posto nella classifica di display per smartphone di DXOMARK, HONOR Magic 5 Pro dispone di un display LTPO mobile, curvo su quattro lati, da 6,81 pollici a 120 Hz. La tecnologia di dimming PWM a 2.160 Hz garantisce un'esperienza di visualizzazione immersiva e confortevole.</p>
  </div>
 </div>
 </div>
