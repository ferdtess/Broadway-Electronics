...
<div class="container">
  ...
  <div class="row">
  <div class="col-2">
  <img src="images/play_vr_2.jpg" width =100%>
  </div>
  <div class="col-2">
  <p>Playstation VR 2</p>
  <h1>Playstation VR 2 Sense</h1>
  <h4>€600.00</h4>
  <input type="number" value="1">
  <a href="" class="btn">Aggiungi al carrello</a>
  <h3>Caratteristiche del prodotto</h3>
  <p> L'innovativa tecnologia di PlayStation VR2 Sense™ dà vita all'emozione e all'immersione tramite le vibrazioni lievi del visore, la tecnologia audio 3D e il tracciamento oculare intelligente, combinati con il rilevamento tattile delle dita, il feedback aptico e i grilletti adattivi del controller PS VR2 Sense.</p>
  </div>
 </div>
 </div>
