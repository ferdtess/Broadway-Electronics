...
<title>Oppo Find X3 Pro - Broadway Electronics</title>
...
<div class="container">
  ...
  <div class="row">
  <div class="col-2">
  <img src="images/oppo-find-x3-pro.png" width =100%>
  </div>
  <div class="col-2">
  <p>Oppo</p>
  <h1>Oppo Find X3 Pro</h1>
  <h4>€469.90</h4>
  <input type="number" value="1">
   <button onclick="addToCart(1)" class="btn">Aggiungi al carrello</button>
  <h3>Caratteristiche del prodotto</h3>
  <p> Cattura i colori del mondo nella loro bellezza più assoluta grazie al rivoluzionario Find X3 Pro. Tonalità ricche e vivide sfumature che illumineranno il futuro della tecnologia. Doppia fotocamera primaria
Una storia in ogni scatto. La fotocamera da 50MP di Find X3 Pro ti permette di fotografare i colori con una facilità e una fedeltà estreme: potrai immortalare all'istante i tuoi ricordi, salvarli a 10bit2 e riviverli ogni volta che vuoi con una qualità spettacolare.</p>
  </div>
 </div>
 </div>
